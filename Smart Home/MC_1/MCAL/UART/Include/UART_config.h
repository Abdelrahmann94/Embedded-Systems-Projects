...
/*      Options: UART_DATA_5_BIT
                 ...
                 UART_DATA_8_BIT 
                 UART_DATA_9_BIT           */
#define UART_uint8_DATA_BIT       UART_DATA_8_BIT
