...
/*      Options: SPI_RISING_FALLING
                 SPI_FALLING_RISING                      */
#define SPI_uint8_CLOCK_POLARITY       SPI_RISING_FALLING

/* configuration of the SPI Clock Phase mode           */
/*      Options: SPI_SAMPLE_SETUP
                 SPI_SETUP_SAMPLE                         */
#define SPI_uint8_CLOCK_PHASE          SPI_SAMPLE_SETUP

/* configuration of the shifting register           */
/*      Options: SPI_SHIFTING_LSB
                 SPI_SHIFTING_MSB         */
#define SPI_uint8_SHIFTING_MODE       SPI_SHIFTING_LSB
...
/*      Options: SPI_CLK_PRESC_4
                 ...
                 SPI_CLK_PRESC_64
                 SPI_CLK_PRESC_128                 */
#define SPI_uint8_CLK_PRESCALING       SPI_CLK_PRESC_4
